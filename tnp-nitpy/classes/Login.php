...
class Login
{
    ...
    public function isAdmin($user_name)
    {
        if ($this->databaseConnection()) {
            ...
            $query_user = $this->db_connection->prepare('SELECT * FROM users WHERE user_name = :user_name AND admin_student=1');
   ...
   private function getUserData($user_name)
    ...
    public function getGravatarImageUrl($email, $s = 50, $d = 'mm', $r = 'g', $atts = array() )
    {
        ...
        $url = '<img src="' . "C:\\xampp\\htdocs\\php-login-advanced\\views\\logo.png" . '"';
