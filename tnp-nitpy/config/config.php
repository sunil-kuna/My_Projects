...
define("EMAIL_SMTP_AUTH", true);
define("EMAIL_SMTP_USERNAME", "sunil.92.2008@gmail.com");
define("EMAIL_SMTP_PASSWORD", "cool2code");
 ...
 */
define("EMAIL_PASSWORDRESET_URL", DOMAIN."password_reset.php");
define("EMAIL_PASSWORDRESET_FROM", "no-reply@example.com");
define("EMAIL_PASSWORDRESET_FROM_NAME", "TNP Project");
define("EMAIL_PASSWORDRESET_SUBJECT", "TNP Trial");
 ...
 */
define("EMAIL_VERIFICATION_URL", DOMAIN."register.php");
define("EMAIL_VERIFICATION_FROM", "no-reply@example.com");
define("EMAIL_VERIFICATION_FROM_NAME", "TNP Project");
define("EMAIL_VERIFICATION_SUBJECT", "TNP Trial");
