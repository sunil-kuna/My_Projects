 	...
 	if(isset($_GET['user_name']))
	{
		...
		if(isset($_POST['submit']))
		{
			if($_POST['submit']=="ADD HR")
			{
				...
				if(!$result)
				{
					echo "CANNOT ADD HR AS COMPANY THIS IS REGISERED IN TNP. REGISTER THE COMPANY FIRST";	
				}
			}
		}
...
<form name="login-form" class="login-form"action="addHR.php?user_id=".$_GET['user_name'] method="post" style="float:center;text-align:center;" >
	<div class="header">
	...
	COMPANY :&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input id="company" name="company" /><br><br>
	...
	<input type="hidden" id="s_id" name="s_id" value="<?php echo $s_id; ?>"> <br><br>
