...
$sql="SELECT c_name,name,source,c_time FROM company INNER JOIN student WHERE company.s_id=student.roll_no ORDER BY c_time DESC ";
...
else
{
	...
	{
		$table=$table."<tr><td>".$row['c_name']."</td><td>". $row['name'] ."</td><td>". $row['source'] ."</td><td>".$row['c_time']."</td></tr>";
	}
	$table=$table."</table>";
}
...
<form name="login-form" class="login-form" action="addcompany.php" method="post" onSubmit="return handleClick()" style="float:center;text-align:center;">
	...
	<input type="hidden" id="s_id" name="s_id" value="<?php echo $stid; ?>"> <br><br>
